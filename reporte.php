                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-hover my-4 py-2">
                                            <thead class="bg-primary text-white">
                                                ...
                                                <img class="img-thumbnail" style="width: 18rem;" src="data:image/jpg;base64,<?php echo base64_encode($row1['imagen']); ?>" alt="Imagen del producto">
                                                </div>
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td><a class="btn btn-success" data-toggle="modal" data-target="#myModal"><?php echo $row1['referencia']; ?></a>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h4 class="modal-title" id="myModalLabel">Imagen del producto</h4>
      ...
      <div class="modal-body text-center">
        <img class="img-thumbnail" style="width: 18rem;" src="data:image/jpg;base64,<?php echo base64_encode($row1['imagen']); ?>" alt="Imagen del producto">
                                                    ...
                                                    <td><?php if($row1['estado']==1){echo "Por confirmar";}else{echo "Confirmada";}?></td>
                                    ...
                                    <tr ><form action="controller_conven.php" method="post">
                                    <input type="text" hidden name="idd" value="<?php echo $row1['id_venta'];?>">
                                    <input type="text" hidden name="stat" value="<?php echo $row1['estado'];?>">
                                    <button class="btn btn-success" type="submit" name="confirm">confirmar venta</button>
                                    </form></tr>
                                <?php } ?>
