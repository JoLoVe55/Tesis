        ...
        <div class="card bg-secondary text-light" style="border-radius: 1rem;">
          ...
          <div class="row g-0">
            ...
            <div class="col-md-6 col-lg-7 d-flex align-items-start">
              ...
              <p class="h1 fw-bold mb-0 p-3  text-center"> ¡¡Nuevo Usuario Registrado!!</p>
              <h5 class="card-title text-center">¡¡Felicidades Se Ha Completado Su Registro con Exito!!</h5>
                <p class="card-text">Ya puede ingresar en nuestro sistema Ingresando los datos de su nueva cuenta</p>
                <a href="login.php" class="btn btn-primary align-items-center">Ingresar</a>
              </div>
            </div>
          </div>
        </div>
